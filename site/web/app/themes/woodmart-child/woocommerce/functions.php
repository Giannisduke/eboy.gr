...
function eboy_gsap_test() {
  if ( is_page( 41450 ) ) {
    wp_enqueue_style( 'summer25_css', get_stylesheet_directory_uri().'/css/summer25_11.css' ); 
    ...
    wp_enqueue_script( 'summer25_1_js', get_stylesheet_directory_uri() . '/js/summer25_1.js', array(), false, true );
  }
} 
