...
function eboy_gsap_home() {
  if ( is_page( 41450 )  ) {
    wp_enqueue_style( 'summer25_css', get_stylesheet_directory_uri().'/css/summer25_14.css' ); 
    ...
    wp_enqueue_script( 'owl_js', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js', array(), false, true );
    wp_enqueue_script( 'owl_js_custom', get_stylesheet_directory_uri() . '/js/owl_js_4.js', array(), false, true );
    wp_enqueue_script( 'summer25_4_m', get_stylesheet_directory_uri() . '/js/summer25_4_m.js', array(), false, true );
  }
} 
