...
import axios from "axios";
    ...
    export default {
        ...
        created() {
            axios
                .get('https://eboy.gr/wp-json/wc/v3/products?featured=true&consumer_key=ck_1bfa47417a538aa339e45a95fcecffda38d1891d&consumer_secret=cs_9babca3e5c1bad1b420748e2ae464393de0d1995')
                .then((response) => {
