...
[How to Sync WooCommerce Product Stock Levels](https://www.wpallimport.com/documentation/syncing-stock/)
...
3. Choose WooCommmerce Products as the import type.
4. Map the incoming data elements to the product fields.
5. Run the import and verify the imported data.

= How do I import product images into WooCommerce? =

1. Go to All Import › New Import.
2. Upload the import file.
3. Select WooCommmerce Products as your import target.
4. Map the incoming data elements to their product fields.
5. Include product image data in the mapping process.
6. Run the import and verify the imported data.

= How do I import product attributes into WooCommerce? =

To import product attributes into WooCommerce, use the Attributes tab of the WooCommerce Add-On section on the Drag & Drop screen. This will let you map incoming attribute data elements to the appropriate product attribute fields.

= How do I add new variations to existing variable products in WooCommerce? =

1. Go to All Import › New Import.
2. Upload the import file with the new variations.
3. Choose WooCommerce Products as the import post type.
4. Map the incoming data elements to their product fields.
4. Use the "I'm importing new variations to existing products" option.
5. Run the import and review the imported products.

= Can I import any WooCommerce product type? =

Yes. You can import any standard WooCommerce product type, including simple products, variable products, simple subscription products, grouped products, and affiliate products. Just set the product type during the import process.
...
3. Upload the bundle file on the destination site.
4. WP All Import will use the bundle file to configure itself.
5. Run the import and check the migrated products.
