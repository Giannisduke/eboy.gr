...
class TagGenerator:
    ...
    WHITELIST = {
        ...
        'ντουλάπα', 'ντουλάπι', 'βιβλιοθήκη', 'γραφείο', 'συρταριέρα', 'κομοδίνο',
    ...
    _CANONICAL_TAGS = {
        ...
        # ντουλάπι / ντουλάπα variants — both are whitelisted as distinct tags.
        # Unaccented "ντουλαπι" and the diminutive "ντουλαπάκι" map to "ντουλάπι".
        'ντουλαπι': 'ντουλάπι',
        'ντουλαπάκι': 'ντουλάπι', 'ντουλαπακι': 'ντουλάπι',
        # συρταριέρα
