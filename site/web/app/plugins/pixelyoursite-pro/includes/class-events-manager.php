...
class EventsManager {
	...
	public function enqueueScripts() {
		...
		wp_register_script( 'js-sha256', PYS_URL . '/dist/scripts/sha256.js', array(), '0.11.0' );
	...
	public function setupEventsParams() {
        ...
        * @var EventsFactory[] $eventsFactory
        ...
        if (count($this->tiktokServerEvents) > 0 &&  Tiktok()->enabled() && Tiktok()->isServerApiEnabled() && !PYS()->isCachePreload()) {
