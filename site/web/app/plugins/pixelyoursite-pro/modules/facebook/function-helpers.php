...
function getAdvancedMatchingParams() {
	...
	if ( PixelYourSite\isWooCommerceActive() ) {
		...
		if ( PixelYourSite\PYS()->woo_is_order_received_page() && wooIsRequestContainOrderId() ) {
    ...
    $params = apply_filters("pys_fb_advanced_matching",$params);
	$sanitized = array();
...
function getCompleteRegistrationOrderParams($event) {
    ...
    $value_option   = PixelYourSite\Facebook()->getOption( 'woo_complete_registration_value_option' );
    $global_value   = PixelYourSite\Facebook()->getOption( 'woo_complete_registration_value_global', 0 );
    $percents_value = PixelYourSite\Facebook()->getOption( 'woo_complete_registration_value_percent', 100 );
