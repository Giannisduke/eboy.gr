...
// Checking that the values are not empty and setting alternative values if they are missing
    ...
    static function paramsToCustomData($data, $singleEvent) {
        ...
        $custom_values = ['event_action','download_type','download_name','download_url','target_url','text','trigger','traffic_source','plugin','user_role','event_url','event_time','event_day','event_month','page_title',"post_type",'post_id','categories','tags','video_type',
